(function()
{
	...
	adList.push({link: urlPrefix + "BANDHAVGARH TIGER RESERVE - SUNRISE TO SUNSET DEC 2015", image: "Sudhir/Trip/Bandhavgarh/Bandhavgarh.jpg", text: "BANDHAVGARH TIGER RESERVE - SUNRISE TO SUNSET DEC 2015", keywords: ["Tiger", "Bandhavgarh", "Pench", "Kanha", "Tadoba", "BigCats"], months: ["Jul", "Aug", "Sep", "Oct", "Nov"]});
	...
	adList.push({link: urlPrefix + "Home Of One Horned Rhino - Kaziranga ", image: "BeyondRoads/Trip/Kaziranga/Kaziranga.jpg", text: "Home Of One Horned Rhino - Kaziranga", keywords: ["Kaziranga", "Tiger Destinations", "Mammal Destinations"], months: ["Oct", "Nov", "Dec"]});		
	...
	adList.push({link: urlPrefix + "Kabini", image: "BeyondRoads/Trip/Kabini/Kabini.jpg", text: "Kabini", keywords: ["Kabini", "Tiger Destinations", "Mammal Destinations"], months: ["Oct", "Nov", "Dec"]});		
	...
	adList.push({link: urlPrefix + "Leopard Lounge", image: "Toehold/Trip/Kabini/Kabini.jpg", text: "Leopard Lounge", keywords: ["Kabini", "Tiger Destinations", "Mammal Destinations"], months: ["Oct", "Nov"]});		
	...
	adList.push({link: urlPrefix + "Pole Trance - Norway", image: "Toehold/Trip/Svalbard/Svalbard.jpg", text: "Pole Trance - Norway", keywords: ["Svalbard", "Exotic Destinations","Mammal Destinations"], months: ["Oct", "Nov","Dec", "Jan","Feb", "Mar", "Apr", "May", "Jun", "Jul"]});		
	...
	adList.push({link: urlPrefix + "Bandhavgarh Tiger Reserve", image: "Sudhir/Trip/Bandhavgarh/Bandhavgarh.jpg", text: "Bandhavgarh Tiger Reserve", keywords: ["Bandhavgarh", "Mammal Destinations", "Tiger Destinations"], months: ["Oct", "Nov","Dec", "Jan", "Feb", "Mar"]});		
	adList.push({link: urlPrefix + "Bandhavgarh Tiger Reserve", image: "Sudhir/Trip/Bandhavgarh/Bandhavgarh.jpg", text: "Bandhavgarh Tiger Reserve", keywords: ["Bandhavgarh", "Mammal Destinations", "Tiger Destinations"], months: ["Oct", "Nov","Dec", "Jan", "Feb", "Mar", "Apr"]});		
